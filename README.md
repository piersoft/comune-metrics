...
[![Paniere v2.6](https://img.shields.io/badge/Paniere-v2.6-blue)](docs/PANIERE.md)
...
- [x] **v0.1** — Paniere v2.6 + 11 JSON Schema + Dashboard MVP single-file
